                        ...
                        <form action="#" method="post" class="form-stacked">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="نام خود را وارد کنید"class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">نام خانوادگی</label>
                                    <div class="controls">
                                        <input type="text" placeholder="نام خانوادگی خود را وارد کنید"class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">پست الکترونیک</label>
                                    <div class="controls">
                                        <input type="email" placeholder="آدرس ایمیل را وارد نمایید" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">تلفن</label>
                                    <div class="controls">
                                        <input type="number" placeholder="شماره تلفن خود را وارد کنید"class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">موبایل</label>
                                    <div class="controls">
                                        <input type="number" placeholder="شماره موبایل خود را وارد کنید" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">نام کاربری</label>
                                    <div class="controls">
                                        <input type="text" placeholder="نام کاربری خود را وارد کنبد" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">رمز عبور</label>
                                    <div class="controls">
                                        <input type="password" placeholder="رمز عبور را وارد نمایید" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">آدرس کامل</label>
                                    <div class="controls">
                                        <input type="text" placeholder="نام کاربری را وارد نمایید" class="input-xlarge">
                                    </div>
                                </div>
                                <hr>
                                <div class="actions"><input tabindex="9" class="btn btn-inverse large" type="submit" id="register-submit" value="ایجاد حساب"></div>
                            </fieldset>
                        </form>
                    </div>
                    <div class="span5">
						...
						<form action="#" method="post">
							...
							<fieldset>
								<div class="control-group">
									<label class="control-label">نام کاربری</label>
									<div class="controls">
										<input type="text" placeholder="نام کاربری را وارد کنید" id="username"  class="input-xlarge">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">رمز عبور</label>
									<div class="controls">
										<input type="password" placeholder="رمز عبور را وارد کنید"   name="password" class="input-xlarge">
									</div>
								</div>
								<div class="control-group">
									<input tabindex="3" class="btn btn-inverse large" type="submit" name="login-submit" value="ورود ">
									<hr>
